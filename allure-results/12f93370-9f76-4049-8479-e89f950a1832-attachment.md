...
- Location: /home/vinayak/Documents/Playwright-Typescript/tests/example.spec.ts:33:5
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Installation' })
    8 × locator resolved to <h1>Installation</h1>
      - unexpected value "visible"

    at /home/vinayak/Documents/Playwright-Typescript/tests/example.spec.ts:40:73
```
  ...
  - article:
    ...
    - heading "Running the Example TestDirect link to Running the Example Test" [level=2]:
      ...
      - link "Direct link to Running the Example Test":
        ...
        - text: "#"
    - paragraph:
      - text: By default tests will be run on all 3 browsers, Chromium, Firefox and WebKit using 3 workers. This can be configured in the
